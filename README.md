...
[**mlens**](https://github.com/flennerhag/mlens)|flennerhag|539|Ml-ensemble – high performance ensemble learning
[**RAdam**](https://github.com/LiyuanLucasLiu/RAdam)|LiyuanLucasLiu|533|On the variance of the adaptive learning rate and beyond
...
[**mmdetection**](https://github.com/open-mmlab/mmdetection)|open-mmlab|5,234|Open mmlab detection toolbox and benchmark
[**FATE**](https://github.com/WeBankFinTech/FATE)|WeBankFinTech|404|An industrial level federated learning framework
...
[**eli5**](https://github.com/TeamHG-Memex/eli5)|TeamHG-Memex|1,470|A library for debugging/inspecting machine learning classifiers and explaining their predictions
...
[**GNN Papers**](https://github.com/thunlp/GNNPapers)|thunlp|4,061|Must-read papers on graph neural networks (gnn)
[**reinforcement learning**](https://github.com/dalmia/David-Silver-Reinforcement-learning)|dalmia|332|Notes for the reinforcement learning course by david silver along with implementation of various algorithms.
